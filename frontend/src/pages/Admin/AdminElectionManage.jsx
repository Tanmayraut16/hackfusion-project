      ...
      const formattedData = {
        ...
        positions: pendingElection.positions.map(pos => ({
          ...
          candidates: pos.candidates.map(candidate => ({
            ...
            bio: candidate.bio,
            student: candidate.student // Include student field in submission
          }))
        }))
      };
      
      const response = await axios.post(
        'http://localhost:3000/api/election',
        formattedData,
        {
          headers: {
    ...
    <div className="space-y-6">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage all your election events from here</p>
        </div>
        <button
      ...
      {pendingElection && (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="text-lg font-medium text-gray-900">Pending Election: {pendingElection.title}</h3>
                  ...
                  <div key={position.id} className="border rounded-lg p-4">
                    ...
                    <div className="mt-2 space-y-2">
                      {position.candidates?.map((candidate) => (
                        <div key={candidate.id} className="flex items-center space-x-3 bg-gray-50 p-2 rounded">
                          <div>
